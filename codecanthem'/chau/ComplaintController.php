...
{
    // 🟣 Hiển thị form báo cáo sản phẩm
    public function showForm(): void
    {
        ...
        if ($productId <= 0) {
            ...
            echo "<h3>Sản phẩm không hợp lệ!</h3>";
            exit;
        }
    ...
    public function submit(): void
    {
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO complaints (product_id, user_id, title, content, status, created_at)
                VALUES (:p, :u, :t, :c, 'pending', datetime('now'))
            ");
            $stmt->execute([
                ':p' => $productId,
